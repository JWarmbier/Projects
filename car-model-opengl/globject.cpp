...
{	
	...
	if (lVAO > MAX_VAO) cout << "Przekroczono maksymalna liczbe VAO w glObject" << endl;
...
void glObject::AddVertex(float x, float y, float z)
{
	...
	if (Coords == NULL) cout << "glObject:: Blad realokacji pamieci" << endl;;
	...
	if (Cols == NULL) cout << "glObject:: Blad realokacji pamieci" << endl;
